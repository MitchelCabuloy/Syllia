...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Syllabus.syllabus_name'
        db.add_column(u'syllabus_syllabus', 'syllabus_name',
                      self.gf('django.db.models.fields.CharField')(default='Syllabus test name', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Syllabus.syllabus_name'
        db.delete_column(u'syllabus_syllabus', 'syllabus_name')
