...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Syllabus.created'
        db.add_column(u'syllabus_syllabus', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Syllabus.last_modified'
        db.add_column(u'syllabus_syllabus', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Syllabus.created'
        db.delete_column(u'syllabus_syllabus', 'created')

        # Deleting field 'Syllabus.last_modified'
        db.delete_column(u'syllabus_syllabus', 'last_modified')
