...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'syllabus_feedback', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'Feedback.fullname'
        db.alter_column(u'syllabus_feedback', 'fullname', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Feedback.email'
        db.alter_column(u'syllabus_feedback', 'email', self.gf('django.db.models.fields.EmailField')(default=None, max_length=75))

        # Changing field 'Feedback.fullname'
        db.alter_column(u'syllabus_feedback', 'fullname', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
    ...
    models = {
        ...
        u'syllabus.feedback': {
            ...
            'fullname': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'syllabus.rubric': {
