...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_faculty', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['authtools.User'], unique=True)),
    ...
    models = {
        u'accounts.faculty': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['authtools.User']", 'unique': 'True'})
        },
        u'auth.group': {
